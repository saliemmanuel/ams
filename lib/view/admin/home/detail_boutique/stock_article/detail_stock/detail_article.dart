...
class DetailAticle extends StatefulWidget {
  ...
  const DetailAticle({super.key, required this.article});
                  ...
                  rows: [
                    DataRow(cells: [
                      ...
                      DataCell(Row(
                        ...
                        children: [
                          CustomText(data: article.stockActuel.toString()),
                          IconButton(
                            icon: const Icon(Icons.edit, color: Colors.black),
                            onPressed: () {
                              dialogueAjout2(
                    ...
                    DataRow(cells: [
                      ...
                      DataCell(Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          CustomText(data: article.stockCritique.toString()),
                          IconButton(
                            icon: const Icon(Icons.edit, color: Colors.black),
                            onPressed: () {
                              dialogueAjout2(
                                  ...
                                  child: EditeWidget(
                                      previusValue:
                                          article.stockCritique.toString(),
                                      isDouble: false,
                                      isString: false,
                                      value: "stockCritique",
                    ...
                    DataRow(cells: [
                      ...
                      DataCell(Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          CustomText(data: article.prixNonAuto.toString()),
                          IconButton(
                            icon: const Icon(Icons.edit, color: Colors.black),
                            onPressed: () {
                              dialogueAjout2(
